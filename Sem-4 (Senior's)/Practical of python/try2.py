...
first_button = Button(top,text="+",foreground="Black",background="red",width=5,command=lambda:sum('+')).grid(row=2,column=1,pady=5)
...
#l1= Label(top,text="Ans",).grid(row=5,column=1,columnspan=2)

l3=Label(top)
l3.grid(row=6,column=0,columnspan=4,pady=10)
